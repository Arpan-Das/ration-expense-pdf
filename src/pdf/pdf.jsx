...
const PDF = () => {
    ...
    const currentMonth = today.getMonth() + 1; // 1-12 (January is 0)
    ...
    return (
        <div className="app-container">
            <div className="form-container">
                <h2 className="form-heading">Generate Ration Chart PDF</h2>
                <div className="form-body">
                    <div className="form-group">
                        <label htmlFor="motherCount">Mother Count:</label>
                        <input
                            type="number"
                            id="motherCount"
                            value={motherCount}
                    ...
                    <div className="form-group">
                        <label htmlFor="childMalCount">Child (Malnutrition) Count:</label>
                        <input
                            type="number"
                            id="childMalCount"
                            value={childMalCount}
                    ...
                    <div className="form-group">
                        <label htmlFor="childOtherCount">Child (Other) Count:</label>
                        <input
                            type="number"
                            id="childOtherCount"
                    ...
                    <div className="form-group">
                        <label htmlFor="extraHoliday">Extra Holidays (days, comma separated):</label>
                        <input
                            type="text"
                            id="extraHoliday"
                    ...
                    <div className="form-group">
                        ...
                        >
                            {Object.entries(monthMapping).map(([monthNo, monthName]) => (
                    ...
                    <button onClick={generatePDF} className="submit-button">
                        Generate PDF
                    </button>
                </div>
            </div>
